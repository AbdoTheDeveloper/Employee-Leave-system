...
<body>
        ...
        <header class="mn-header navbar-fixed">
            <nav class="cyan darken-1">
                <div class="nav-wrapper row">
                    ...
                    <div style="margin-left:63vw;display:inline ">
                        <a class="dropdown-button btn cyan  " href="#" data-activates="dropdown1">Language
    ...
    <script>// Initialize dropdown
        $(document).ready(function () {
            $('.dropdown-button').dropdown({
                hover: false, // Dropdown is activated on click
                alignment: 'left', // Aligns dropdown to the left
